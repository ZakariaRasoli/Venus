...
chats = {}
plugins = {}
helper_username = ZXApiBot --Put Your Helper UserName . Not (@) For UserName
...
function create_config( )
  ...
  -- A simple config with basic plugins and ourselves as privileged user
    ...
    info_text = [[  ‍ ‌‌‌‌       ‌‌‌‌ • Venus | Anti Spam BOT v5.2

• GitHub : https://github.com/ZakariaRasoli/Venus

• Admins :
• @ZakariaR ➣ Founder & Developer
