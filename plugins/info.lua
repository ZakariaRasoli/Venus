--Begin info.lua By @ZakariaR
local Zakaria = 139328010
...
local function info_cb(arg, data)
  ...
  lastname = ""
   ...
   local text = "_• First name :_ *"..firstname.."*\n_• Last name :_ *"..lastname.."*\n_• Username :_ "..username.."\n_• ID :_ *"..data.id_.."*\n\n"
		    if data.id_ == tonumber(Zakaria) then
		     ...
		     elseif is_owner1(arg.chat_id, data.id_) then
		       text = text..'_• Rank :_ 👩‍✈️ *Group Owner*\n\n'
...
--This Is info.lua for VenusBOT Source :)
